...
Galleria = function() {
    ...
    var lightbox = this._lightbox = {
        ...
        init : function() {
            ...
            var elems = 'overlay controls wrapper box content shadow title info close prevholder prev nextholder next counter image',
                el = {},
                op = self._options,
                css = '',
            ...
            $.each({
                 //   wrapper: 'box',
                    ...
                    info: 'title counter',
                    content: 'info image',
                    controls: 'close prevholder nextholder',
                    prevholder: 'prev',
                    nextholder: 'next'
                }, function( key, val ) {
                    var arr = [];
            ...
            $( DOM().body ).append( el.overlay, el.wrapper, el.box, el.controls );
...
//                    'margin-left': Math.ceil( destWidth / 2 ) *- 1
        ...
        hide: function() {
            ...
            $(lightbox.elems.wrapper).hide();
            $(lightbox.elems.controls).hide();
        ...
        show: function(index) {
            ...
            $(lightbox.elems.wrapper).show().css('visibility', 'visible');
            $(lightbox.elems.controls).show().css('visibility', 'visible');
